...
<div id="fisherman_win_image" class="d-none">
...
const fishermanFightImage = document.getElementById('fisherman_fight_image');
const fishermanWinImage = document.getElementById('fisherman_win_image');
...
punchElement.addEventListener('click', function() {
    if (heroAttack > fishermanDefense) {
        ...
        fishermanFightImage.classList.add('d-none');
        fishermanWinImage.classList.remove('d-none');
